...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Gruppe Annahda | Unsere Projekte</title>
        ...
        <div id="page-menu" class="no-sticky">
            ...
            <div id="page-menu-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-title">Unsere <span>Projekte</span></div>
                    ...
                    <div id="portfolio" class="clearfix">
                        ...
                        <article class="portfolio-item pf-media pf-icons">
                            ...
                            <div class="portfolio-desc">
                                <h3><a href="portfolio-single-gallery.php?idProjet=<?= $projet->id() ?>">Residenz <?= $projet->name() ?></a></h3>
