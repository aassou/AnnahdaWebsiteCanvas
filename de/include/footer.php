                ...
                <div class="col_two_third">
                    <div class="widget clearfix">
                        ...
                        <div style="background: url('/images/world-map.png') no-repeat center center; background-size: 100%;">
                            ...
                            <abbr title="Telefon"><strong>Telefon:</strong></abbr> +212 (0) 5 36 33 10 31<br>
    ...
    <div id="copyrights">
        <div class="container clearfix">
            <div class="col_half">
                ...
                <div class="copyright-links"><a href="#">Nutzungsrechte</a> / <a href="#">Datenschutz</a></div>
            </div>
            <div class="col_half col_last tright">
                ...
                <div class="clear"></div>
                <i class="icon-envelope2"></i> groupeannahda@gmail.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> Groupe_Annahda <span class="middot">&middot;</span> <i class="icon-skype2"></i> GroupeAnnahda uns Skype
            </div>
        </div>
    </div>
</footer>