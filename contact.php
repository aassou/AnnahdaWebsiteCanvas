...
<head>
    ...
    <title>Groupe Annahda | Contact</title>
</head>
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title">
            <div class="container clearfix">
                <h1>Contact</h1>
                <span>N'hesitez pas de nous contacter, nous sommes à votre écoute </span>
            </div>
        </section>
        <section id="content">
                ...
                <div class="container clearfix">
                    <div class="col_half">
                        ...
                        <form class="nobottommargin" id="template-contactform" name="template-contactform" action="include/sendemail.php" method="post">
                            ...
                            <div class="col_full">
                                <button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="button button-3d nomargin">Envoyer</button>
                            </div>
                        </form>
                    ...
                    <div class="row clear-bottommargin">
                        ...
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Nous-Appeler<span class="subtitle">(00212) 05 36 33 10 31</span></h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Appelle sur Skype<span class="subtitle">GroupeAnnahda</span></h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Page Facebook<span class="subtitle">1300 J'aime</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
