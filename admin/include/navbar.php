                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="http://gdj.gdj.netdna-cdn.com/wp-content/uploads/2013/05/free-flat-icons-set-thumb.jpg">Salam, <?= $_SESSION['userAnnahdaSite']->login() ?> <b class="caret"></b>
                        </a>
                        <ul style="margin-top:14px;" role="menu" class="dropdown-setting dropdown-menu">
                            <li>
                                <a href="#">
                                    <span class="entypo-user"></span>&#160;&#160;Mon Profile</a>
                            </li>
                            <!--li>
                                <a href="#">
                            ...
                            <li>
                                <a href="logout.php">
                                    <span class="entypo-logout"></span>&#160;&#160;Déconnexion</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="icon-gear"></span>&#160;&#160;Thémes</a>
