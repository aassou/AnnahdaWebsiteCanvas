            ...
            <div id="tree-wrap">
                <div class="side-bar">
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="dashboard.php" title="Les projets">
                                <i class="icon-window"></i>
                                <span>Accueil</span>
                            </a>
                        </li>
                        <li>
                            <a class="tooltip-tip ajax-load" href="projets.php" title="Les projets">
                                <i class="icon-home"></i>
                                <span>Les Projets</span>
                            </a>
                        </li>
                        <li>
                            <a class="tooltip-tip ajax-load" href="media.php" title="Les Medias">
