                    ...
                    <div class="col_one_third portfolio-single-content col_last nobottommargin">
                        ...
                        <ul class="skills">
                            <li data-percent="<?= $projet->avancementConstruction() ?>">
                                <span>Trabajos de construcción</span>
                                <div class="progress">
                        ...
                        <ul class="portfolio-meta bottommargin">
                            <li><span><i class="icon-user"></i>Creado por</span> Grupo Annahda</li>
                            <li><span><i class="icon-calendar3"></i>Fecha de lanzamiento</span> <?= date('d/m/Y', strtotime($projet->dateCreation())) ?></li>
                            <li><span><i class="icon-map-marker2"></i>Dirección</span> <a><?= $projet->adresse() ?></a></li>
                        </ul>
