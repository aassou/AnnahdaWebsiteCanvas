<footer id="footer" class="dark">
        ...
        <div class="footer-widgets-wrap clearfix">
                    ...
                    <div class="widget clearfix">
                        ...
                        <div style="background: url('/images/world-map.png') no-repeat center center; background-size: 100%;">
                            <address>
                                ...
                                Frente a la Escuela Secundaria Nador Jadid (Anaanaa) Nador.<br>
                            </address>
                            <abbr title="Teléfono"><strong>Teléfono:</strong></abbr> +212 (0) 5 36 33 10 31<br>
                            <abbr title="Movil"><strong>Movil:</strong></abbr> +212 (0) 6 61 55 11 35<br>
            ...
            <div class="col_one_third col_last">
                <div class="widget subscribe-widget clearfix">
                    <h5><strong>Suscribirse </ strong> boletín de noticias nuestras ofertas y novedades llegar</h5>
    ...
    <div id="copyrights">
        <div class="container clearfix">
            <div class="col_half">
                Todos los derechos reservados para la empresa Groupe Annahda Lil Iaamar &copy; 2016.<br>
                <div class="copyright-links"><a href="#">Licencias</a> / <a href="#">Intimidad de datos</a></div>
            </div>
            <div class="col_half col_last tright">
                ...
                <div class="clear"></div>
                <i class="icon-envelope2"></i> groupeannahda@gmail.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> Groupe_Annahda <span class="middot">&middot;</span> <i class="icon-skype2"></i> GroupeAnnahda en Skype
            </div>
        </div>
    </div>
</footer>