                ...
                <div class="col_two_third">
                    <div class="widget clearfix">
                        ...
                        <div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
                            ...
                            <abbr title="Phone Number"><strong>Teléfono:</strong></abbr> (00212) 05 36 33 10 31<br>
    ...
    <div id="copyrights">
        <div class="container clearfix">
            <div class="col_half">
                ...
                <div class="copyright-links"><a href="http://goo.gl/eLJ2Bg">Licencias</a> / <a href="http://goo.gl/eLJ2Bg">Intimidad de datos</a></div>
            </div>
