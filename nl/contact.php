...
<head>
    ...
    <title>Groep Annahda | Contact</title>
</head>
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title">
            <div class="container clearfix">
                <h1>Contact</h1>
                <span>Aarzel niet om contact met ons op, we horen </span>
            </div>
        </section>
        <section id="content">
                ...
                <div class="container clearfix">
                    <div class="col_half">
                        ...
                        <form class="nobottommargin" id="template-contactform" name="template-contactform" action="include/sendemail.php" method="post">
                            ...
                            <div class="col_full">
                                <button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="button button-3d nomargin">Sturen</button>
                            </div>
                        </form>
                    ...
                    <div class="col_half col_last"><?php include('../include/google-maps.php'); ?></div>
                    <div class="clear"></div>
                    <div class="row clear-bottommargin">
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Adres<span class="subtitle">Ouled Brahim B1 Nador</span></h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Telefoontje <span class="subtitle">(00212) 05 36 33 10 31</span></h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Bel ons Skype<span class="subtitle">GroupeAnnahda</span></h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 bottommargin clearfix">
                            <div class="feature-box fbox-center fbox-bg fbox-plain">
                                ...
                                <h3>Facebook-pagina<span class="subtitle">1300 wedstrijden</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
